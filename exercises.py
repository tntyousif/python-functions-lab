...
print('Exercise 4: Convert 37°C to Fahrenheit:', convert_temperature(37, 'C'))
print('Exercise 4: Convert 40°F to Celsius:', convert_temperature(100, 'F'))
...
print('Exercise 6:', largest(1, 2, 6))
